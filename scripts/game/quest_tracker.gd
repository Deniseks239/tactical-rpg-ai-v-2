...
var active_quests: Dictionary = {}  # quest_id -> {title, description, objective, reward, progress, is_completed}
...
func accept_quest(quest_id: String, title: String, description: String, objective: String, target_count: int, reward: String):
